...
/**
 * Created by Ramkesh Singh on 07-02-2017.
 */
...
public class GamePanel extends SurfaceView implements SurfaceHolder.Callback
{
    ...
    public void surfaceCreated(SurfaceHolder holder){
        ...
        bg = new Background(BitmapFactory.decodeResource(getResources(), R.drawable.wbg));
    ...
    public void drawText(Canvas canvas)
    {
        ...
        if((player.getScore()*2)>best)
        {
            best = (player.getScore()*2);
